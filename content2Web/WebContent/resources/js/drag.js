...
var functionAfterExplorerBarWasDragged="";
var functionBeforeExplorerBarWasDragged="";
var barOffsetX=0;
...
_ToolManDragGroup.prototype = {
	...
	_dragInit : function(event) {		
		setTimeout(functionBeforeExplorerBarWasDragged,1);
	...
	_drag : function(event) {
		...
		barOffsetX = newTopLeftPosition.x;
	...
	_dragEnd : function(event) {
		//document.title = barOffsetX + " :: " + this.toolManDragGroup.element.offsetLeft + " :::: " + document.body.clientWidth;		
		event = ToolMan.events().fix(event)
		var group = this.toolManDragGroup
		...
		setTimeout(functionAfterExplorerBarWasDragged,1);
	},
...
ToolMan._dragFactory._constraintFactory = {
	...
	horizontal : function() {
		return function(coordinate, dragEvent) {
			...
			var ret =  coordinate.y != y? coordinate.factory.create(coordinate.x, y) : coordinate;
			return ret;
		}
	}
}
